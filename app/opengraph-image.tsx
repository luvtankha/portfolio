...
export const alt = "LUV TANKHA — Full-Stack Developer & Aspiring AI Engineer";
...
export default function OpenGraphImage() {
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "70px", color: "#F4F4F5", background: "radial-gradient(circle at 85% 15%, #3a256d 0, transparent 30%), #09090B", fontFamily: "Arial, sans-serif" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column" }}><span style={{ color: "#A1A1AA", fontSize: 26, letterSpacing: 5 }}>FULL-STACK DEVELOPER</span><span style={{ marginTop: 22, fontSize: 84, fontWeight: 700, letterSpacing: -4 }}>LUV TANKHA</span><span style={{ marginTop: 18, color: "#A78BFA", fontSize: 36 }}>Building toward AI Engineering</span></div>
